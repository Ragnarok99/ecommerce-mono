...
import banner4 from 'src/assets/images/banner-4.png';
import banner5 from 'src/assets/images/banner-5.png';
import banner6 from 'src/assets/images/banner-6.png';
